        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              this.sendButtonLoc(jid, action === 'add' ? wel.toBuffer() : lea.toBuffer(), text, 'Whatsapp Bot', action === 'add' ? 'SELAMAT DATANG!', `${usedPrefix}say Disapa dulu dong member barunya suruh intro dulu :)` : 'SELAMAT TINGGAL!', `${usedPrefix}say Semoga dia tenang di alam sana ya!`, null, false, {
                contextInfo: {
                  mentionedJid: [user]
                }
              })
